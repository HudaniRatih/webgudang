			...
			<div class="card-body">
				...
				<form class="form-horizontal form-material" id="formBarang">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<textarea rows="5" class="form-control form-control-line form-user-input" name="keterangan" id="keterangan" placeholder="Ceritakan barang"></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="text" placeholder="Inputkan Jumlah barang" class="form-control form-control-line form-user-input" name="jumlah_barang" id="jumlah_barang">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="text" placeholder="Inputkan stock barang" class="form-control form-control-line form-user-input" name="stock" id="stock">
						</div>
					</div>
...
<script type="text/javascript">
	...
	function sendDataPost() {
		...
		if ($titel == 'Form Edit Data Barang') {
			echo "var link = 'https://webgudang.bulubook.com/barang/update_action/';";
		} else {
			echo "var link = 'https://webgudang.bulubook.com/barang/create_action/';";
		}
		?>
	...
	function getDetail(id_barang){
		var link = 'https://webgudang.bulubook.com/barang/detail?id_barang='+id_barang;
		...
		$.ajax(link,{
			...
			success: function (data,status,xhr){
				...
				if (data_obj['sukses'] == 'ya') {
					...
					$('#jumlah_barang').val(detail['jumlah_barang']);
